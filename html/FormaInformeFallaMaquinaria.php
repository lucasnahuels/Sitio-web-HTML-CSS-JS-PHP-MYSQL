...
<html> 
<head>
	<title> Informe falla maquinaria </title>
	<style type="text/css">
...
<h1 id="titulo"> Informe falla maquinaria </h1>
...
<label for="c">Número maquinaria: </label> <input type="text" id="c" name="NroMaquinaria"> <br/><br/>
